...
void VL53L1CX_Init(void){                                                               // "VL53L1CX_Init"
    ...
    buffer[0] = 0x01;
    buffer[1] = 0x0F;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                  //
    I2C_ReadNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                    //

    buffer[0] = 0x00;
    buffer[1] = 0x00;
    buffer[2] = 0x00;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 3);                                  //
    ...
    buffer[1] = 0xE5;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                  //
    I2C_ReadNBytes(VL53L1CX_ADDR, &buffer[0], 1);                                    //
    ...
    buffer[2] = 0x0A;
    buffer[3] = 0x00;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 4);                                  //
    ...
    buffer[4] = 0x07;
    buffer[5] = 0x3A;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 6);                                  //
    ...
    buffer[1] = 0x31;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                  //
    I2C_ReadNBytes(VL53L1CX_ADDR, &buffer[0], 12);                                    //
    ...
    buffer[1] = 0x89;
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                  //
    I2C_ReadNBytes(VL53L1CX_ADDR, &buffer[0], 17);                                    //
...
float VL53L1CX_Millimeter_GetValue(void){                                               // "VL53L1CX_Millimeter_GetValue"
    ...
    buffer[1] = 0x96;            //89 +10
    I2C_WriteNBytes(VL53L1CX_ADDR, &buffer[0], 2);                                  //
    I2C_ReadNBytes(VL53L1CX_ADDR, &readBuffer[0], 17);                                    //
